...
public class ExceptionHandler {
    @org.springframework.web.bind.annotation.ExceptionHandler(HeaderMissing.class)
    public ResponseEntity<StandardError> headerMissing(HeaderMissing headerMissing) {
        HttpStatus httpStatus = HttpStatus.FORBIDDEN;
        StandardError standardError = new StandardError(Instant.now(), httpStatus.value(), headerMissing.getMessage());
